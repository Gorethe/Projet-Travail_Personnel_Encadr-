...
#done
BINDIR=$HOME/projettpe/codenook/bin
export PATH="$BINDIR:$PATH"
export PATH=~/projettpe/codenook/bin/bin:$PATH
OLLAMA_INSTALL_DIR=$HOME/projettpe/codenook/bin
mkdir -p $OLLAMA_INSTALL_DIR

#cp -r /home/christine/codenook/bin $OLLAMA_INSTALL_DIR/
